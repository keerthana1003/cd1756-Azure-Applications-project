...
class Config(object):
    ...
    CLIENT_SECRET = "hJI8Q~~zSNxGLWa53mVBD4RgtF0KyQiJB9AB6bYk"
    ...
    CLIENT_ID = "23b82eec-67fe-4381-b82f-9af770e1b995"

    REDIRECT_PATH = "https://keerthanacmsapp-cdfeamdkhfhwf4fj.centralus-01.azurewebsites.net/getAToken"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
